#!/usr/bin/env python3
"""
Convert .docx files to .md with correct formatting preservation:
- Titles and headings (with proper levels)
- Bold and italic text ONLY where originally formatted
        ...
        for run in paragraph.findall('.//w:r', self.namespaces):
            ...
            for text_elem in run.findall('.//w:t', self.namespaces):
                if text_elem.text:
                    ...
                    # Apply formatting only if explicitly set
